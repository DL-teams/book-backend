...
CREATE TABLE `bms_card` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='图书证信息表';
...
CREATE TABLE `bms_category` (
  `id` int NOT NULL AUTO_INCREMENT,
  `code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '分类编号',
  ...
  `is_deleted` tinyint(1) DEFAULT '0' COMMENT '删除flag',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='图书分类信息表';

-- ----------------------------
-- Records of bms_category
-- ----------------------------
BEGIN;
INSERT INTO `bms_category` VALUES (1, 'code1', '社会科学', 0, 1, 0, '社会科学1', '社会科学2', 0);
INSERT INTO `bms_category` VALUES (2, 'code2', '社会科学总论', 1, 1, 0, '社会科学总论1', '社会科学总论2', 0);
INSERT INTO `bms_category` VALUES (3, 'code3', '政治', 1, 1, 1, '政治1', '政治2', 0);
COMMIT;

-- ----------------------------
-- Table structure for bms_category_mapping
-- ----------------------------
DROP TABLE IF EXISTS `bms_category_mapping`;
CREATE TABLE `bms_category_mapping` (
  `id` int NOT NULL AUTO_INCREMENT,
  `book_id` int DEFAULT NULL,
  `category_id` int DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='图书分类关系映射表';

-- ----------------------------
-- Records of bms_category_mapping
-- ----------------------------
BEGIN;
COMMIT;
...
CREATE TABLE `bms_info` (
  `id` int NOT NULL AUTO_INCREMENT,
  `code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '图书编号',
  `bar_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '条形码',
  ...
  `number` int NOT NULL COMMENT '总册数',
  `bookcase` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '所属书架',
  ...
  `is_deteled` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='图书信息表';
...
-- ----------------------------
-- Table structure for bms_press
-- ----------------------------
DROP TABLE IF EXISTS `bms_press`;
CREATE TABLE `bms_press` (
  `id` int NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for bms_press_mapping
-- ----------------------------
DROP TABLE IF EXISTS `bms_press_mapping`;
CREATE TABLE `bms_press_mapping` (
  `id` int NOT NULL AUTO_INCREMENT,
  `book_id` int NOT NULL COMMENT '图书id',
  `press_id` int NOT NULL COMMENT '出版社id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='图书出版社关系映射表';

-- ----------------------------
-- Records of bms_press_mapping
-- ----------------------------
BEGIN;
COMMIT;

-- ----------------------------
-- Table structure for bms_record
-- ----------------------------
...
-- ----------------------------
BEGIN;
INSERT INTO `ums_admin` VALUES (3, 'admin', '$2a$10$AY8s/xFlwJaiJdZRDCTOoOdF4vRXSIizNN0oD9YZ3DTNfQxWuW6Gm', 'http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180607/timg.jpg', 'admin@163.com', '系统管理员', '系统管理员', '2018-10-08 13:32:47', '2019-04-20 12:45:16', 1);
...
CREATE TABLE `ums_admin_login_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=296 DEFAULT CHARSET=utf8 COMMENT='后台用户登录日志表';
...
INSERT INTO `ums_admin_login_log` VALUES (287, 10, '2022-02-20 21:37:08', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (288, 3, '2022-02-20 22:30:17', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (289, 3, '2022-02-20 22:33:45', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (290, 3, '2022-02-20 22:48:48', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (291, 3, '2022-02-21 09:10:27', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (292, 3, '2022-02-21 14:56:45', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (293, 3, '2022-02-21 15:29:17', '192.168.12.68', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (294, 3, '2022-02-21 21:55:20', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (295, 3, '2022-02-22 09:23:37', '0:0:0:0:0:0:0:1', NULL, NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `ums_menu` VALUES (1, 0, '2020-02-02 14:50:36', '图书', 0, 0, 'bms', 'book', 0);
INSERT INTO `ums_menu` VALUES (2, 1, '2020-02-02 14:51:50', '图书列表', 1, 0, 'book', 'book-list', 0);
INSERT INTO `ums_menu` VALUES (3, 1, '2020-02-02 14:52:44', '添加图书', 1, 0, 'addBook', 'book-add', 1);
INSERT INTO `ums_menu` VALUES (4, 1, '2020-02-02 14:53:51', '图书分类', 1, 0, 'bookCate', 'book-cate', 0);
INSERT INTO `ums_menu` VALUES (5, 1, '2020-02-02 14:54:51', '图书出版社', 1, 0, 'bookPress', 'book-press', 0);
INSERT INTO `ums_menu` VALUES (6, 1, '2020-02-02 14:56:29', '品牌管理', 1, 0, 'book', 'book-brand', 1);
INSERT INTO `ums_menu` VALUES (7, 0, '2020-02-02 16:54:07', '借还', 0, 0, 'oms', 'order', 0);
...
INSERT INTO `ums_menu` VALUES (12, 0, '2020-02-04 16:18:00', '历史', 0, 0, 'sms', 'sms', 0);
...
INSERT INTO `ums_menu` VALUES (21, 0, '2020-02-07 16:29:13', '用户', 0, 0, 'ums', 'ums', 0);
...
INSERT INTO `ums_menu` VALUES (29, 0, '2022-02-21 08:30:26', '查询', 0, 0, 'search', 'order', 0);
INSERT INTO `ums_menu` VALUES (30, 29, '2022-02-21 08:57:38', '图书查询', 1, 0, 'bookList', 'product-list', 0);
INSERT INTO `ums_menu` VALUES (31, 29, '2022-02-21 09:06:15', '借阅查询', 1, 0, 'borrowList', 'product-list', 0);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `ums_role` VALUES (5, '管理员', '拥有所有查看和操作功能', 0, '2020-02-02 15:11:05', 1, 0);
INSERT INTO `ums_role` VALUES (9, '操作员', NULL, 0, '2022-02-20 23:02:23', 1, 0);
INSERT INTO `ums_role` VALUES (10, '学生', NULL, 0, '2022-02-20 23:02:41', 1, 0);
COMMIT;
...
CREATE TABLE `ums_role_menu_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=290 DEFAULT CHARSET=utf8 COMMENT='后台角色菜单关系表';
...
INSERT INTO `ums_role_menu_relation` VALUES (263, 5, 1);
INSERT INTO `ums_role_menu_relation` VALUES (264, 5, 2);
INSERT INTO `ums_role_menu_relation` VALUES (265, 5, 3);
INSERT INTO `ums_role_menu_relation` VALUES (266, 5, 4);
INSERT INTO `ums_role_menu_relation` VALUES (267, 5, 5);
INSERT INTO `ums_role_menu_relation` VALUES (268, 5, 6);
INSERT INTO `ums_role_menu_relation` VALUES (269, 5, 7);
INSERT INTO `ums_role_menu_relation` VALUES (270, 5, 8);
INSERT INTO `ums_role_menu_relation` VALUES (271, 5, 9);
INSERT INTO `ums_role_menu_relation` VALUES (272, 5, 10);
INSERT INTO `ums_role_menu_relation` VALUES (273, 5, 11);
INSERT INTO `ums_role_menu_relation` VALUES (274, 5, 12);
INSERT INTO `ums_role_menu_relation` VALUES (275, 5, 13);
INSERT INTO `ums_role_menu_relation` VALUES (276, 5, 14);
INSERT INTO `ums_role_menu_relation` VALUES (277, 5, 16);
INSERT INTO `ums_role_menu_relation` VALUES (278, 5, 17);
INSERT INTO `ums_role_menu_relation` VALUES (279, 5, 18);
INSERT INTO `ums_role_menu_relation` VALUES (280, 5, 19);
INSERT INTO `ums_role_menu_relation` VALUES (281, 5, 20);
INSERT INTO `ums_role_menu_relation` VALUES (282, 5, 21);
INSERT INTO `ums_role_menu_relation` VALUES (283, 5, 22);
INSERT INTO `ums_role_menu_relation` VALUES (284, 5, 23);
INSERT INTO `ums_role_menu_relation` VALUES (285, 5, 24);
INSERT INTO `ums_role_menu_relation` VALUES (286, 5, 25);
INSERT INTO `ums_role_menu_relation` VALUES (287, 5, 29);
INSERT INTO `ums_role_menu_relation` VALUES (288, 5, 30);
INSERT INTO `ums_role_menu_relation` VALUES (289, 5, 31);
COMMIT;
